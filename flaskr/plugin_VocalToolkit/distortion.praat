...
form Distortion (clipping)
	...
	button Soft clipping. Quintic
	button Soft clipping. Cubic
	button Soft clipping. Hyperbolic tangent
	button Soft clipping. Algebraic
	button Soft clipping. Arctangent
	real Input_gain_(dB) 0.0 (= no change)
	real Positive_amplitude_limit_(Pa) 0.5
	real Negative_amplitude_limit_(Pa) -0.5
	choice Output_gain 1
	button No change
	button Scale to original average intensity
	button Normalize (scale peak 0.99)
